      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-black text-gray-900 mb-4">Advertising Guidelines</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Please review our content policies to ensure your advertisements meet our quality and community standards.
            </p>
          </div>

          <div className="max-w-4xl mx-auto bg-gray-50 rounded-2xl overflow-hidden shadow-lg">
            <div className="bg-gradient-to-r from-red-500 to-pink-500 p-6">
              <h3 className="text-2xl font-bold text-white mb-2">Content Guidelines & Policies</h3>
              <p className="text-red-100">All advertisements are reviewed before approval to maintain quality standards</p>
            </div>
            ...
            <div className="p-8">
                ...
                <div className="bg-white rounded-xl p-6 border-l-4 border-red-500 shadow-sm">
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start">
                      ...
                      <span><strong>Nude या अश्लील content:</strong> कोई भी नग्न या अश्लील सामग्री स्वीकार नहीं की जाएगी</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-500 mr-3 mt-1">✗</span>
                      <span><strong>Inappropriate Language:</strong> गाली-गलौच या अपमानजनक भाषा का उपयोग वर्जित है</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-500 mr-3 mt-1">✗</span>
                      <span><strong>Alcohol & Tobacco:</strong> शराब, तंबाकू या नशीले पदार्थों का विज्ञापन नहीं</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-500 mr-3 mt-1">✗</span>
                      <span><strong>Violence & Hate:</strong> हिंसक या नफरत फैलाने वाली सामग्री</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-red-500 mr-3 mt-1">✗</span>
                      <span><strong>Copyright Violation:</strong> बिना अनुमति दूसरों के logo या content का उपयोग</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 border-l-4 border-green-500 shadow-sm">
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start">
                      ...
                      <span><strong>Business Promotion:</strong> अपने व्यापार, सेवाओं का विज्ञापन</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-500 mr-3 mt-1">✓</span>
                      <span><strong>Educational Content:</strong> शिक्षा, कौशल विकास, जागरूकता</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-500 mr-3 mt-1">✓</span>
                      <span><strong>Events & Celebrations:</strong> शादी, पार्टी, त्योहार के लिए</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-500 mr-3 mt-1">✓</span>
                      <span><strong>Social Causes:</strong> समाजिक कार्य, चैरिटी, स्वच्छता अभियान</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-500 mr-3 mt-1">✓</span>
                      <span><strong>Clean Entertainment:</strong> पारिवारिक मनोरंजन सामग्री</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mt-8 bg-blue-50 rounded-xl p-6 border border-blue-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                  <div className="text-center">
                    ...
                    <h5 className="font-semibold text-gray-900 mb-2">High Resolution</h5>
                    <p className="text-gray-600">न्यूनतम 300 DPI, A3 size तक support</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-3">
                      <span className="text-white font-bold">✓</span>
                    </div>
                    <h5 className="font-semibold text-gray-900 mb-2">Professional Review</h5>
                    <p className="text-gray-600">हमारी team द्वारा quality check</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-purple-500 rounded-full flex items-center justify-center mx-auto mb-3">
                      <span className="text-white font-bold">24h</span>
                    </div>
                    <h5 className="font-semibold text-gray-900 mb-2">Quick Approval</h5>
                    <p className="text-gray-600">24 घंटे में approval status</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                ...
                <ul className="space-y-2 text-yellow-800 text-sm">
                  <li>• सभी advertisements की manual review होती है</li>
                  <li>• Inappropriate content के लिए account ban हो सकता है</li>
                  <li>• Guidelines का उल्लंघन करने पर refund नहीं मिलेगा</li>
                  <li>• हमारा फैसला अंतिम और बाध्यकारी होगा</li>
                </ul>
              </div>
            </div>
          </div>
