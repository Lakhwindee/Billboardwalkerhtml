...
- **SEPARATE PASSWORD CHANGE SECTIONS (Aug 17, 2025)**: Created distinct password change interfaces for Admin and Campaign Manager roles - Admin sees red/pink themed "Change Admin Password" section with "वर्तमान एडमिन पासवर्ड" labels, Campaign Manager sees green themed "Change Campaign Manager Password" section with "वर्तमान पासवर्ड" labels, both using same backend API with proper role-based visibility and validation
